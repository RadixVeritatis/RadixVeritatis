...
* **Deterministic Latency:** Engineered a Retrieval-Augmented Classification (RAC) pipeline executing model inference and Explainable AI (XAI) feature attribution in **0.1s to 0.2s** on bare-metal ARM64 loops.
